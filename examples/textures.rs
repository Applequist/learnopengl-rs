...
impl OpenGLApp for Textures {
    ...
    fn initialize(&mut self, current_time: Instant) {
        let vertices = [
            ...
            Vertex { position: [0.5, -0.5, 0.0], color: [0.0, 1.0, 0.0], tex: [1.0, 0.0] },
            Vertex { position: [-0.5, -0.5, 0.0], color: [0.0, 0.0, 1.0], tex: [0.0, 0.0] },
            Vertex { position: [-0.5, 0.5, 0.0], color: [1.0, 1.0, 0.0], tex: [0.0, 1.0] },
        ];
        ...
        let image = image::open("res/textures/img.png").unwrap();
